...
def _help_content(language: str) -> dict[str, str]:
    content: dict[str, dict[str, str]] = {
        "en": {
            ...
            "mechanics_item_1": "Homework is now one dedicated flow: the learner opens Homework, chooses a round size, and continues the remaining assigned words instead of choosing between daily or weekly sections.",
            ...
            "visibility_item_1": "Homework shows the current task, remaining words, due date, the chosen round size, and a progress indicator that moves forward after correct answers.",
        ...
        "ru": {
            ...
            "mechanics_item_1": "Теперь домашка идёт одним отдельным потоком: ученик открывает домашку, выбирает размер раунда и продолжает оставшиеся назначенные слова без деления на daily или weekly разделы.",
            ...
            "visibility_item_1": "В домашке видно текущее задание, сколько слов осталось, дедлайн, выбранный размер раунда и индикатор прогресса, который двигается после правильных ответов.",
        ...
        "uk": {
            ...
            "mechanics_item_1": "Тепер домашка йде одним окремим потоком: учень відкриває домашку, обирає розмір раунду і продовжує решту призначених слів без поділу на daily чи weekly розділи.",
            ...
            "visibility_item_1": "У домашці видно поточне завдання, скільки слів залишилося, дедлайн, обраний розмір раунду і індикатор прогресу, який рухається після правильних відповідей.",
